...
bool appello::set_id_esame_nell_appello(const string &id_esame, const vector<string> &id_cds, const vector<string> &anno,
...
bool appello::trovato_cds_anno(const vector<string> &id_cds, const vector<string> &anno, const int inserisco_nel_giorno) {
